...
# indiğinde BEYAZ olarak başlıyor (varsayılan kutu rengi
# siyah olduğu için beyaz hint daha okunaklı).
FORM_GIRIS_ONER_VARSAYILAN = BEYAZ
...
YAZI_RENK_SECENEKLERI = {
    "Beyaz (Varsayılan)": FORM_GIRIS_ONER_VARSAYILAN,
    "Siyah": SIYAH,
