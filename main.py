...
# Hint (yer tutucu) yazı rengi. İstek üzerine siyah yapıldı.
FORM_GIRIS_ONER = SIYAH
...
class IsTakipApp(App):
    ...
    def build(self):
        ...
        # Kayıtlı giriş kutusu rengi varsa (ayarlar.json),
        # ekranlar (ve içindeki hint kutuları) oluşturulmadan
        # önce FORM_GIRIS'e uygulanır.
        kutu_rengini_yukle()
