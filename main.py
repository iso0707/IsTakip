...
def yazi_rengini_uygula(yeni_renk, kaydet_json=True):
    ...
    for widget in list(_HINT_YAZI_KAYITLARI):
        ...
        try:
            ...
            # NOT: Kivy'nin TextInput'u, hint metnini yeniden
            # çizme tetikleyicisini sadece hint_text DEĞİŞTİĞİNDE
            # ateşliyor; hint_text_color tek başına değişince
            # (widget zaten ekrandaysa) yeniden çizim tetiklenmez
            # ve eski renk ekranda kalmaya devam eder. Bunu aşmak
            # için hint_text'i kısaca değiştirip eski haline
            # geri döndürerek yeniden çizimi zorluyoruz.
            _onceki_hint = widget.hint_text
            widget.hint_text = (
                "" if _onceki_hint else " "
            )
            widget.hint_text = _onceki_hint
