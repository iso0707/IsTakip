...
# değişmeden kalır.
FORM_GIRIS_VARSAYILAN = (0.949, 0.949, 0.949, 1)  # F2F2F2 - varsayılan kutu rengi

# FORM_GIRIS artık sabit değil; ayarlar.json'da kayıtlı bir
# renk varsa (bkz. AYARLAR / GİRİŞ KUTUSU RENGİ bölümü) o
# yüklenir, yoksa varsayılan (F2F2F2) kullanılır. Bu değişken
# kutu_rengini_uygula() ile çalışma anında da güncellenir.
FORM_GIRIS = FORM_GIRIS_VARSAYILAN

FORM_GIRIS_CIZGI = (1, 1, 1, 0.18)
FORM_GIRIS_YAZI = SIYAH

# Hint (yer tutucu) yazı rengi. Artık sabit değil; kutu rengi
# gibi ayarlar.json'dan yüklenir ve yazi_rengini_uygula() ile
# çalışma anında güncellenebilir. Varsayılan: siyah.
FORM_GIRIS_ONER_VARSAYILAN = SIYAH
...
KUTU_RENK_SECENEKLERI = {
    "Beyaz (Varsayılan)": FORM_GIRIS_VARSAYILAN,
...
YAZI_RENK_SECENEKLERI = {
    "Siyah (Varsayılan)": FORM_GIRIS_ONER_VARSAYILAN,
    "Beyaz": BEYAZ,
