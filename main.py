...
class YeniIs(Screen):
    ...
    def __init__(
        ...
        **kwargs
        ...
        form.add_widget(self.gorusme_tarihi)
...
class Gecmis(Screen):
    ...
    def yenile(self):
        ...
        for index in range(
            ...
            # Butonun sağ tarafında, iki başlık halinde:
            # işin başladığı (seçilen) tarih ve
            # görüşme/anlaşma tarihi.
...
class GelirGider(Screen):
    ...
    def yenile(self):
        ...
        self.tahsilat_karti.tutar_ayarla(
            f"{tl_bicimle(h['ay_gelir'])} TL"
        )

        self.gider_karti.tutar_ayarla(
            f"{tl_bicimle(h['ay_gider'])} TL"
        )

        self.malzeme_karti.tutar_ayarla(
            f"{tl_bicimle(h['ay_malzeme'])} TL"
        )

        self.iscilik_karti.tutar_ayarla(
            f"{tl_bicimle(h['ay_iscilik'])} TL"
        )
