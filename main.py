...
KOYU_MAVI_BUTON = (0.945, 0.949, 0.969, 1)  # F1F2F7 - çok açık, soğuk gri
...
# değişmeden kalır.
FORM_GIRIS = KOYU_MAVI_BUTON
FORM_GIRIS_CIZGI = (1, 1, 1, 0.18)
FORM_GIRIS_YAZI = BEYAZ
FORM_GIRIS_ONER = (1, 1, 1, 1)
...
def buton(
    ...
    if renk is None:
        ...
        # Zemin siyah olduğu için yazı beyaz olmalı.
        ekstra["color"] = BEYAZ
