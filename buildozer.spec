...
# Not: Açılışta logo görseli gösterilmesin diye kaldırıldı,
# sadece aşağıdaki android.presplash_color rengi kullanılıyor.
...
android.presplash_color = #1F2126
...
android.permissions = INTERNET,POST_NOTIFICATIONS,RECEIVE_BOOT_COMPLETED,WAKE_LOCK,SCHEDULE_EXACT_ALARM,FOREGROUND_SERVICE,READ_MEDIA_IMAGES,READ_EXTERNAL_STORAGE,WRITE_EXTERNAL_STORAGE
